      ...
      description={
        <>
          <Text as="p" marginBottom={4}>
            The form consists of two sections: <i>Credentials</i> and{" "}
            <i>Address</i>.
          </Text>
          <Text as="p">
          ...
          <Box as="ol" margin={0} marginBottom={4}>
            <li>
              <Text>
                ...
                <TextLink
                  href="https://support.taxjar.com/article/659-address-validation"
                  newTab
                >
                  the desired format
                </TextLink>
          ...
          <Text as="p" marginBottom={4}>
            ...
            <TextLink
              href="https://developers.taxjar.com/api/reference/"
              newTab
            >
