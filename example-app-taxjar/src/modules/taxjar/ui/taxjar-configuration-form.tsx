...
export const TaxJarConfigurationForm = (
  props: TaxJarConfigurationFormProps
) => {
  ...
  return (
    <AppCard>
      ...
      <form
        ...
        data-testid="taxjar-configuration-form"
      >
        <Input
          control={control}
          name="name"
            ...
            <AppToggle
              ...
              helperText={
                <HelperText>
                  Toggling between{" "}
                  <TextLink
                    href="https://developers.taxjar.com/integrations/testing/"
                    newTab
                  >
