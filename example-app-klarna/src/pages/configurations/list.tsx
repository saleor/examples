...
function ListConfigurationPage() {
  ...
  return (
    <AppLayout title="Klarna">
      <AppLayoutRow
        title="Klarna Configurations"
        description="Create Klarna configurations that can be later assigned to Saleor channels."
        ...
        description={
          <Box>
            <Text as="p" variant="body" size="medium">
              Assign Klarna configurations to Saleor channels.
            </Text>
            {!channelMappings.isLoading && !hasAnyMappings && (
              <Box marginTop={6}>
                ...
                <Text as="p" variant="body" size="medium" color="textCriticalDefault">
                  This means payments are not processed by Klarna.
                </Text>
              </Box>
            )}
          </Box>
