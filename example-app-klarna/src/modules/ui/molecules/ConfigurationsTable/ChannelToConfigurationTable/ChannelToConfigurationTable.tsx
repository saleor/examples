...
import { ChipKlarnaOrange, ChipNeutral, ChipSuccess } from "@/modules/ui/atoms/Chip/Chip";
...
import { getEnvironmentFromUrl } from "@/modules/klarna/klarna-api";
    ...
    <Tr>
      ...
      <Td className={classNames(tableStyles.td, tableStyles.statusColumnTd)}>
        {!selectedConfiguration?.apiUrl ? (
          ...
          <ChipKlarnaOrange>PLAYGROUND</ChipKlarnaOrange>
        )}
      </Td>
    </Tr>
  );
