...
export const AddCredentialsForm = ({
  ...
  const { data: klarnaConfigurationData } =
  ...
  useEffect(() => {
    if (klarnaConfigurationData) {
      reset({
        apiUrl: klarnaConfigurationData.apiUrl,
        username: klarnaConfigurationData.username,
        password: klarnaConfigurationData.password,
        configurationName: klarnaConfigurationData.configurationName,
      });
    }
  }, [klarnaConfigurationData, reset]);
    ...
    >
      <Box paddingBottom={6} rowGap={4} display="flex" flexDirection="column" width="100%">
        ...
        <FormSelect
          ...
          size="medium"
          options={[
            { label: "Playground Europe", value: "https://api.playground.klarna.com/" },
            { label: "Playground North America", value: "https://api-na.playground.klarna.com/" },
            { label: "Playground Oceania", value: "https://api-oc.playground.klarna.com/" },
            { label: "---", value: "" },
            { label: "Production Europe", value: "https://api.klarna.com/" },
            { label: "Production North America", value: "https://api-na.klarna.com/" },
            { label: "Production Oceania", value: "https://api-oc.klarna.com/" },
          ]}
        />
      </Box>
    </RoundedBoxWithFooter>
